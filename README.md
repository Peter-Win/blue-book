...
&(term) - подстановка термина из словаря

&[Tab 5.1] - ссылка на таблицу. Вместо Tab может быть тюбой текст (т.к. слово Таблица может склоняться). А вместо 5.1 - соответствующий номер таблицы.